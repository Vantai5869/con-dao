...
const vi = {
  ...
  'document.tabQr': 'QR Căn cước/CCCD',
  'document.qrTitle': 'Mã QR CĂN CƯỚC/VNeID',
  'document.qrHint': 'Chụp mã QR hoặc tải ảnh có sẵn từ thiết bị',
  // Deliberately doesn't promise auto-detection like qr.hint (ticket-scan step) does — this step
  // also has a manual capture button, so auto-detect failing isn't a dead end.
  'document.qrScanHint': 'Đưa mã QR vào khung',
  'document.captureAction': 'Chụp ảnh',
  'document.uploadFromDevice': 'Tải ảnh lên',
...
const en: Record<TranslationKey, string> = {
  ...
  'document.tabQr': 'ID Card QR',
  'document.qrTitle': 'ID Card / VNeID QR Code',
  'document.qrHint': 'Capture the QR code or upload an existing photo',
  'document.qrScanHint': 'Place the QR code in the frame',
  'document.captureAction': 'Take photo',
  'document.uploadFromDevice': 'Upload photo',
...
const zh: Record<TranslationKey, string> = {
  ...
  'document.tabQr': '身份证二维码',
  'document.qrTitle': '身份证/VNeID 二维码',
  'document.qrHint': '拍摄二维码或从设备上传照片',
  'document.qrScanHint': '将二维码放入取景框',
  'document.captureAction': '拍照',
  'document.uploadFromDevice': '上传照片',
...
const ja: Record<TranslationKey, string> = {
  ...
  'document.tabQr': 'ID QRコード',
  'document.qrTitle': 'ID/VNeID QRコード',
  'document.qrHint': 'QRコードを撮影するか、端末から写真をアップロードしてください',
  'document.qrScanHint': 'QRコードを枠内に合わせてください',
  'document.captureAction': '撮影する',
  'document.uploadFromDevice': '写真をアップロード',
...
const ko: Record<TranslationKey, string> = {
  ...
  'document.tabQr': 'ID QR코드',
  'document.qrTitle': 'ID/VNeID QR코드',
  'document.qrHint': 'QR코드를 촬영하거나 기기에서 사진을 업로드하세요',
  'document.qrScanHint': 'QR 코드를 프레임 안에 맞추세요',
  'document.captureAction': '사진 촬영',
  'document.uploadFromDevice': '사진 업로드',
